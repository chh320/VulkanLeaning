...
private:
    ...
    void mainLoop() {
        ...
        vkDeviceWaitIdle(device); // wait logical device finish its' work before cleanup
    }
    ...
    void createLogicalDevice() {
        ...
        deviceFeatures.sampleRateShading = VK_TRUE; // enable sample feature for the device
    ...
    void createGraphicsPipeline() {
        ...
        multisampling.minSampleShading = 2.0f;  // min fraction for sample shading; closer to one is smoother
    ...
    void copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
        ...
        vkCmdCopyBuffer(commandBuffer, srcBuffer, dstBuffer, 1, &copyRegion);   // copy memory
    ...
    void generateMipmaps(VkImage image, VkFormat imageFormat,int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
        ...
        for (uint32_t i = 1; i < mipLevels; i++) {  // from i = 1
    ...
    void loadModel() {
        ...
        std::cerr << "vertices number: " << vertices.size() << " indices number: " << indices.size() << std::endl;
    }
